...
import 'kleur/colors';
import { $ as $$Layout, A as ArrowLeftRight } from '../chunks/Layout_DgpgtHox.mjs';
import { a as getTransactions, b as getBudgets } from '../chunks/budget.utils_Dv1ePa-3.mjs';
import { $ as $$Transaction } from '../chunks/Transaction_C9Km2UI8.mjs';
...
const $$Dashboard = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const [transactions, budgets] = await Promise.all([
    getTransactions(1, { by: "recent", page: 0, perPage: 5 }),
    getBudgets()
  ]);
...
Recent Transactions
    ...
    (transaction) => renderTemplate`${renderComponent($$result2, "Transaction", $$Transaction, { "transaction": transaction, "budgets": budgets, "mode": "simple" })}`
