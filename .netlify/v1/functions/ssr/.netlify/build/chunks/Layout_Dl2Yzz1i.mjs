import { e as createComponent, f as createAstro, h as addAttribute, l as renderScript, r as renderTemplate, m as maybeRenderHead, k as renderComponent, s as spreadAttributes, n as renderSlot, o as renderHead } from './astro/server_FhSrvt_g.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                         */
...
const $$NavLink = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$NavLink;
  const { href, title, Icon } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<a${addAttribute(href, "href")} class="flex flex-col items-center p-4"> ${renderComponent($$result, "Icon", Icon, { "stroke-width": 1, "width": "30", "height": "30" })} <span class="hidden sm:block"> ${title} </span> </a>`;
}, "C:/web-projecs/budget-app/src/components/NavLink.astro", void 0);
...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en"> <head><meta charset="utf-8"><meta name="viewport" content="width=device-width"><meta name="generator"${addAttribute(Astro2.generator, "content")}><title>Budget-App</title>${renderComponent($$result, "ClientRouter", $$ClientRouter, {})}${renderHead()}</head> <body class="min-h-screen bg-gradient-to-br from-bg-1 to-bg-2 bg-fixed text-base-text font-base"> <header class="flex items-center justify-between gap-4 p-4 text-blue"> <a href="/" class="flex items-center gap-1 font-theme"> ${renderComponent($$result, "SkullIcon", Skull, { "size": 30 })} <span class="text-xl font-semibold tracking-wide">SKLbudget</span> </a> ${auth && renderTemplate`<a href="/profile"> ${renderComponent($$result, "CircleUserRoundIcon", CircleUserRound, { "width": "30", "height": "30" })} </a>`} </header> <div class="fixed bottom-4 w-full z-[9999]"> <nav class="flex w-[80vw] md:w-fit justify-between mx-auto bg-bg-1/90 backdrop-blur-lg rounded-md text-sm"> ${renderComponent($$result, "NavLink", $$NavLink, { "href": "/", "title": "Dashboard", "Icon": LayoutDashboard })} ${renderComponent($$result, "NavLink", $$NavLink, { "href": "/transactions", "title": "Transactions", "Icon": ArrowLeftRight })} ${renderComponent($$result, "NavLink", $$NavLink, { "href": "/budgets", "title": "Budgets", "Icon": Calendar })} ${renderComponent($$result, "NavLink", $$NavLink, { "href": "/debt", "title": "Debt Tracker", "Icon": ChartColumnDecreasing })} ${renderComponent($$result, "NavLink", $$NavLink, { "href": "/income", "title": "Income Tracker", "Icon": ChartColumnIncreasing })} </nav> </div> <main class="p-4"> ${renderSlot($$result, $$slots["default"])} </main> </body></html>`;
