import { e as createAstro, f as createComponent, m as maybeRenderHead, k as renderComponent, n as renderSlot, l as renderScript, r as renderTemplate, h as addAttribute } from './astro/server_BvKLBLe3.mjs';
import 'kleur/colors';
import { c as createLucideIcon } from './config_C7KY7e6E.mjs';
import { $ as $$LoadingButton, T as Trash2 } from './LoadingButton_BiUD550v.mjs';
...
Delete Transaction
` })} </div> ` })} ${renderScript($$result, "C:/web-projecs/budget-app/src/pages/transactions/_components/DeleteTransaction.astro?astro&type=script&index=0&lang.ts")}`;
}, "C:/web-projecs/budget-app/src/pages/transactions/_components/DeleteTransaction.astro", void 0);
...
Cancel
` })} ` })} ${renderComponent($$result, "LoadingButton", $$LoadingButton, { "state": { initial: "Save", loading: "Saving...", error: " Failed", success: "Saved!" }, "variant": "fill", "Icon": Save, "type": "submit", "class": "w-full" })} </div> </form> ` })} ${renderScript($$result, "C:/web-projecs/budget-app/src/pages/transactions/_components/EditTransaction.astro?astro&type=script&index=0&lang.ts")}`;
}, "C:/web-projecs/budget-app/src/pages/transactions/_components/EditTransaction.astro", void 0);
