import { e as createComponent, f as createAstro, m as maybeRenderHead, n as renderSlot, r as renderTemplate, h as addAttribute, k as renderComponent, l as renderScript } from './astro/server_FhSrvt_g.mjs';
import 'kleur/colors';
import 'clsx';
import { c as createLucideIcon } from './Layout_Dl2Yzz1i.mjs';
...
const $$Dialog = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<dialog class="backdrop:bg-bg-1 md:backdrop:bg-bg-1/95 " closedby="any"> <div class="fixed position-center p-8 rounded-xl shadow-blue/10 shadow-lg w-[90vw] sm:w-auto sm:min-w-[600px] text-base-text"> <h3 class="font-semibold text-2xl text-base-text mb-8"> ${title} </h3> ${renderSlot($$result, $$slots["default"])} </div> </dialog>`;
...
Amount: <br> <input type="number" name="amount"> </label> <label>
