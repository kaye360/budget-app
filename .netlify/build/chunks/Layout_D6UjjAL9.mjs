...
import 'kleur/colors';
import { c as createLucideIcon, S as Skull, A as APP_NAME, $ as $$ClientRouter } from './config_C7KY7e6E.mjs';
/* empty css                         */
/* empty css                         */
...
const $$Nav = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const navLinks = [
    ...
    { href: "/transactions/add", title: "Add", Icon: BanknoteArrowUp },
...
export { $$Layout as $, ArrowLeftRight as A, BanknoteArrowUp as B };
