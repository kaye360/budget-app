...
import 'kleur/colors';
import { $ as $$Button } from './Button_Qb-THzOg.mjs';
...
const $$LoadingButton = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "loading-button", "loading-button", { "state": "default" }, { "default": () => renderTemplate` ${renderComponent($$result, "Button", $$Button, { "variant": variant, "Icon": Icon, "class": className, ...props }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "default-state", "default-state", { "class": "inline-block" }, { "default": () => renderTemplate`${state.default}` })} ${renderComponent($$result2, "loading-state", "loading-state", { "class": "inline-block" }, { "default": () => renderTemplate`${state.loading}` })} ${renderComponent($$result2, "error-state", "error-state", { "class": "inline-block" }, { "default": () => renderTemplate`${state.error}` })} ${renderComponent($$result2, "success-state", "success-state", { "class": "inline-block" }, { "default": () => renderTemplate`${state.success}` })} ` })} ` })} ${renderScript($$result, "C:/web-projecs/budget-app/src/components/Button/LoadingButton.astro?astro&type=script&index=0&lang.ts")}`;
}, "C:/web-projecs/budget-app/src/components/Button/LoadingButton.astro", void 0);

const $$TransactionModal = createComponent(async ($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Modal", $$Modal, { "title": "Transaction Options" }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "transaction-edit", "transaction-edit", {}, { "default": () => renderTemplate` ${maybeRenderHead()}<form class="grid sm:grid-cols-2 gap-4 border-l border-blue pl-4 mb-12"> <h3 class="sm:col-span-2 text-lg font-semibold tracking-wide">
Edit Transaction
</h3> <label>
...
Account: <br> <select name="account-name" class="w-full"> <option value="account-1">account 1</option> <option selected value="account-2">account 2</option> </select> </label> <div class="sm:col-span-2 grid grid-cols-2 gap-4"> ${renderComponent($$result2, "close-modal-button", "close-modal-button", {}, { "default": () => renderTemplate` ${renderComponent($$result2, "Button", $$Button, { "variant": "outline", "Icon": Ban, "type": "button", "class": "w-full block" }, { "default": async ($$result3) => renderTemplate`
Cancel
` })} ` })} ${renderComponent($$result2, "LoadingButton", $$LoadingButton, { "state": { default: "Save", loading: "Saving...", error: "Failed.", success: "Saved!" }, "variant": "fill", "Icon": Save, "type": "submit", "class": "w-full" })} </div> </form> ` })} ${renderComponent($$result2, "transaction-delete", "transaction-delete", {}, { "default": () => renderTemplate` <div class="grid gap-4 justify-start border-l border-blue pl-4"> <h3 class="text-lg font-semibold tracking-wide">Delete this action?</h3> <p> <strong>Note:</strong> This action can be undone.
</p> ${renderComponent($$result2, "Button", $$Button, { "variant": "destruct", "Icon": Trash2, "class": "w-full" }, { "default": async ($$result3) => renderTemplate`
Delete Transaction
` })} </div> ` })} ` })} ${renderScript($$result, "C:/web-projecs/budget-app/src/pages/transactions/_components/TransactionModal.astro?astro&type=script&index=0&lang.ts")}`;
