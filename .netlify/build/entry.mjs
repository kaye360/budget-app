...
import { manifest } from './manifest_SQxor0lA.mjs';
...
const _page8 = () => import('./pages/transactions.astro.mjs');
const pageMap = new Map([
    ...
    ["src/pages/transactions/index.astro", _page8]
]);
...
const _args = {
    "middlewareSecret": "0314cc25-744e-4e82-b0a6-8cee7d637174"
};
