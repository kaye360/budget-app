...
import 'kleur/colors';
import { T as Trash2, $ as $$LoadingButton } from '../../chunks/LoadingButton_BGFS10UO.mjs';
import { $ as $$Layout } from '../../chunks/Layout_DgpgtHox.mjs';
import { $ as $$Button } from '../../chunks/Button_C8tZvlGl.mjs';
import 'clsx';
import { b as getBudgets } from '../../chunks/budget.utils_Dv1ePa-3.mjs';
import { c as createLucideIcon } from '../../chunks/app.config_C9KMaloa.mjs';
...
Budget: <br> <select name="budgetId-0" data-name="budgetId" class="w-full"> ${budgets.map((budget) => renderTemplate`<option${addAttribute(budget.id, "value")}>${budget.name}</option>`)} </select> </label> <label>
